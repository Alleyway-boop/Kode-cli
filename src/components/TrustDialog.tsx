    ...
    <>
      <Box flexDirection="column" gap={1} padding={1} borderStyle="round" borderColor={theme.warning}>
        ...
        <Box flexDirection="column" gap={1}>
          <Text>
            {PRODUCT_NAME} may read files in this folder. Reading untrusted files may lead to {PRODUCT_NAME} to behave
            in an unexpected ways.
          </Text>
          <Text>
            With your permission {PRODUCT_NAME} may execute files in this folder. Executing untrusted code is unsafe.
          </Text>
        </Box>
