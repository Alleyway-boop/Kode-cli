...
function getToolUseFromMessages(toolUseID: string, messages: Message[]): ToolUseBlockParam | null {
...
export function useGetToolFromMessages(toolUseID: string, tools: Tool[], messages: Message[]) {
  return useMemo(() => {
